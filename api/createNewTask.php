<?php
	...
	{        
		$sql = "INSERT INTO `platform_project` (proName, projectType, headPerson, phone, introduction, createTime, startTime, endTime, adminCheck, checkPerson, taskMoney, taskPoint) 
        VALUES ('".$taskTitle."', ".$taskType.", ".$headPerson.", '".$phone."', '".$taskIntro."', '".$createTime."', '".$beginDateTime."', '".$endDateTime."', ".$adminCheck.", ".$checkPerson.", ".$taskMoney.", ".$taskPoint.")";
		// $res = $sql;
        // echo $sql;
