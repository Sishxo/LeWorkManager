<?php
    ...
    $page = $_POST['page'];
    $length = $_POST['length'];
	$uncheckedSalaryCondition = $_POST['uncheckedSalaryCondition'];
	...
	else
	{
        ...
        // echo $nowDateTime;
		$sql = "SELECT * FROM `platform_project` WHERE ((adminCheck = 0) and ((taskMoney > 0) or (taskPoint > 0)) AND (projectType = 12) AND (proName LIKE '%"
			.$uncheckedSalaryCondition."%')) ORDER BY createTime DESC LIMIT ".$startNum.", ".$length;
		// echo $sql;
