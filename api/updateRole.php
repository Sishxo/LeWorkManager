<?php
	...
	{        
		// 标签
        $sql = "UPDATE `platform_role` SET roleName = '".$roleName."', wantPersonNum = ".$wantPersonNumChanged.
        ", leastPersonNum = ".$leastPersonNumChanged.", signUpBeginTime = '".$signUpBeginDateTime."', signUpEndTime = '".$signUpEndDateTime.
        "' WHERE id = ".$roleId;
        // $res = $sql;
